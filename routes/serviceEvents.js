...
exports.list = function(req, res){
    ...
    console.log(filter);
    var valid_filters = ["level", "service", "details"];
    ...
    return schema.serviceEvents.find(filter, 100, function (err, events) {
        if (!err) {
          return res.json({serviceEvents: events});
        } else {
...
exports.create = function(req, res) {
    ...
    e.forEach(function(event) {
        ...
        var obj = new schema.serviceEvents.model(event);
        console.log(obj);
